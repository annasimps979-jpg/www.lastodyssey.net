...
|Poultice|1|5 cr|Using a single Poultice will ensure that the Mend [action](../../Extras/Key-Terms#term-action) automatically succeeds.  Using a Poultice while resting in proper accommodations will heal 1 extra injury per day.|
...
|<dfn id = "term-map">Map</dfn>|1|Mundane 50, Rare 250, Expert 500 cr|A map of an area reduces the navigation difficulty of traveling the paths that it includes by an amount that depends on its Quality.  Mundane reduces the navigation difficulty by 1, Rare by 3, and Expert by 7.|
...
|:-|:-|:-|
|Stormbreaker|250 cr|This Scroll can only be used during a Storm.  When rolling to determine the weather during the following travel round, the [GM](../../Extras/Key-Terms#term-gm) must reroll until the result is something other than a Storm.|
