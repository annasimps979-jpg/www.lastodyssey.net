...
|Name|Description|
|:-|:-|
|Keen|This upgrade gives a bonus to either your Status, Magical, or Physical Accuracy whose value depends on its [UV](../../The-Economy/Equipment#term-upgrade-value).  UV 1 gives a +1, UV 2 gives a +3, and UV 3 gives a +5.|
...
|Name|Description|
|:-|:-|
|Elemental|Instead of dealing [colorless](../../Combat-Rules/Elemental-Types#term-colorless) physical damage, this weapon's [basic attack](../../Combat-Rules/The-Combat-Round#term-basic-attack) deals [elemental](../../Combat-Rules/Elemental-Types) physical damage of a fixed type.  This upgrade cannot be applied more than once to a single weapon.|
|Slayer|When you hit an enemy of the [enemy type](../../Enemies/Enemy-Creation#term-enemy-type) specified by this upgrade, the damage is multiplied by 1.5x in addition to other modifiers.  This upgrade cannot stack, but you can have multiple Slayer upgrades of different types on the same weapon.|
...
|Toxic|When you hit an enemy with this weapon's basic attack, it also inflicts one level of the [debuff](../../Combat-Rules/Buffs-and-Debuffs#term-debuff) specified by this upgrade.  This ability cannot stack, but a weapon can have this effect for multiple different kinds of debuffs at once.|
...
|Blunt|This weapon's basic attack is replaced with an ability that makes a Melee physical attack against an enemy.  On a hit, this attack does not do damage, but instead reduces the [AP](../../Combat-Rules/The-Combat-Round#term-ap) that the enemy can use during its next [turn](../../Combat-Rules/The-Combat-Round#term-turn) by one.  You can hit an enemy with this attack multiple times per turn, but you cannot reduce its AP below zero.|
...
|Name|Description|
|:-|:-|
|Temporal|Once per turn, not including [held turns](../../Combat-Rules/The-Combat-Round#term-hold-ap), you may reverse the effects of any abilities you used during your turn in order to regain all of your AP.|
