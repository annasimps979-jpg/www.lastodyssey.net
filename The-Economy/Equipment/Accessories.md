...
|Upgrade|Description|
|:-|:-|
|Shield|This type of accessory grants a +1 to one of your Defense [statistics](../Extras/Key-Terms#term-statistic).  This effect can stack with other bonuses of the same type.|
...
|Volatile|When you use an ability that costs MP while wearing this accessory, roll a 1d10.  If the result is greater than 5, the ability does not cost any MP, while if the result is 5 or below, the ability costs double MP.  If you cannot afford the double MP cost in the latter case, the ability still fires but you immediately drop to 0 MP.|
...
|Mana Battery|This accessory has a linked pool of 5 temporary MP that you can draw on while you are wearing it rather than your base MP pool.  This MP resets at the beginning of every [battle](../Extras/Key-Terms#term-battle).|
...
|Grant Edge|At the start of a battle, if you are wearing this accessory, you gain a +1 to your [base](../Extras/Key-Terms#term-base) Initiative.  This bonus can stack with any other bonuses to Initiative that you have.|
