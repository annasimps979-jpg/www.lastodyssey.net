...
|Upgrade|Description|
|:-|:-|
|Shield|This type of accessory grants a +1 to either your [Physical](../../Characters/Abilities-and-Statistics#term-physical-defense) or [Magical Defense](../../Characters/Abilities-and-Statistics#term-magical-defense).  This effect can stack with other bonuses of the same type.|
...
|Volatile|When you use an ability that costs [MP](../../Characters/Abilities-and-Statistics#term-mp) while wearing this accessory, roll a 1d10.  If the result is greater than 5, the ability does not cost any MP, while if the result is 5 or below, the ability costs double MP.  If you cannot afford the double MP cost in the latter case, the ability still fires but you immediately drop to 0 MP.|
|Item Sleeve|When you use the item specified by this upgrade that involves a 1d10 roll, you may roll an additional 1d10 and freely choose which result you take.  If there is not a 1d10 roll involved, it instead doubles the item's potency or adds an extra enhancement.  For example, a healing item that normally heals 10 [HP](../../Characters/Abilities-and-Statistics#term-hp) will now heal 20, or an item sleeve for a Scan item might turn it into Multiscan.|
...
|[Mana](../../Characters/Abilities-and-Statistics#term-mana) Battery|This accessory has a linked pool of 5 temporary MP that you can draw on while you are wearing it rather than your base MP pool.  This MP resets at the beginning of every [battle](../../Extras/Key-Terms#term-battle).|
...
|Auto Heal|During the Effect Phase of every round, if you are wearing this accessory you automatically heal for 5 HP.  If you are [downed](../../Characters/Abilities-and-Statistics#term-downed), this accessory does nothing.|
|Grant Edge|At the start of a battle, if you are wearing this accessory, you gain a +1 to your [base](../../Extras/Key-Terms#term-base) [Initiative](../../Characters/Abilities-and-Statistics#term-initiative).  This bonus can stack with any other bonuses to Initiative that you have.|
