...
|<dfn id = "term-melee">Melee</dfn>|This ability may only be used when the user is in the [front row](/combat/starting#term-front-row), and may only target characters that are in the front row.|
...
|<dfn id = "term-passive">Passive</dfn>|This ability cannot be used as an [action](/extras/key-terms#term-action), but instead changes something about the way the character behaves in [combat](/combat).|
