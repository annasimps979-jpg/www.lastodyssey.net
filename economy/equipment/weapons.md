...
|Name|Description|
|:-|:-|
|Keen|This upgrade gives a bonus to either your Status, Magical, or Physical Accuracy whose value depends on its [UV](/economy/equipment#term-upgrade-value).  UV 1 gives a +1, UV 2 gives a +3, and UV 3 gives a +5.|
|Extra Ability|When a character wields a weapon with this upgrade, they are able to use an extra [flex power](/characters/character-advancmement#term-flex-power), [job](/characters/jobs) ability, or [archetype](/characters/archetypes) [ability](/extras/key-terms#term-ability) at its normal [MP](/characters/attributes-and-statistics#term-mp) cost.  At UV 1, the ability is earned at of Rank 1-3 of the job or archetype that can use it, at UV 2 the ability is earned at Rank 4-6, and at UV 3 the ability is earned at rank 7-9.  Flex powers always count as UV 1.|
...
|Sharpened|After you hit an enemy with a [physical attack](/combat/attacking-and-defending#term-physical-attack) while wielding a weapon with this upgrade, you can add an amount of damage to the end result of the damage calculation (that is, after all multipliers have been applied) given by the UV of the upgrade.  UV 1 gives +1 extra damage, UV 2 gives +3 extra damage, and UV 3 gives +5 extra damage.|
|Energized|After you hit an enemy with a [magical attack](/combat/attacking-and-defending#term-magical-attack) while wielding a weapon with this upgrade, you can add an amount of damage to the end result of the damage calculation (that is, after all multipliers have been applied) given by the UV of the upgrade.  UV 1 gives +1 extra damage, UV 2 gives +3 extra damage, and UV 3 gives +5 extra damage.|

### UV 1

|Name|Description|
|:-|:-|
|Elemental|Instead of dealing [colorless](/combat/elemental-types#term-colorless) physical damage, this weapon's [basic attack](/combat/round#term-basic-attack) deals [elemental](/combat/elemental-types) physical damage of a fixed type.  This upgrade cannot be applied more than once to a single weapon.|
|Slayer|When you hit an enemy of the [enemy type](/enemies/creation#term-enemy-type) specified by this upgrade, the damage is multiplied by 1.5x in addition to other modifiers.  This upgrade cannot stack, but you can have multiple Slayer upgrades of different types on the same weapon.|
|Light|In addition to their usual basic attack, weapons with this upgrade give the wielder a free ability called Light Attack.  When the wielder uses this ability, they make two colorless, [Melee](/combat/attacking-and-defending#term-melee), physical attacks against a single target, each one dealing damage multiplied by 0.75x in addition to other modifiers.|
|Toxic|When you hit an enemy with this weapon's basic attack, it also inflicts one level of the [debuff](/combat/buffs-and-debuffs#term-debuff) specified by this upgrade.  This ability cannot stack, but a weapon can have this effect for multiple different kinds of debuffs at once.|
...
|Name|Description|
|:-|:-|
|Cursed|When you hit an enemy with this weapon's basic attack, you also inflict the [status](/combat/statuses) specified by this upgrade.|
|Blunt|This weapon's basic attack is replaced with an ability that makes a Melee physical attack against an enemy.  On a hit, this attack does not do damage, but instead reduces the [AP](/combat/round#term-ap) that the enemy can use during its next [turn](/combat/round#term-turn) by one.  You can hit an enemy with this attack multiple times per turn, but you cannot reduce its AP below zero.|
|Ambushing|At the beginning of a [battle](/extras/key-terms#term-battle), you may make a free basic attack against any target within range of this weapon's basic attack before the [Initiative Order](/combat/starting#term-initiative-order) is determined.  If your [party](/extras/key-terms#term-party) has [First Strike](/combat/starting#term-first-strike), you can make this attack for free during the First Strike round in addition to any other [actions](/extras/key-terms#term-action).|
...
|Name|Description|
|:-|:-|
|Reach|This weapon's Melee abilities can hit enemies in the [back row](/combat/starting#term-back-row) or the [front row](/combat/starting#term-front-row) while the wielder is in the front row, and can also hit enemies in the front row while the wielder is in the back row.|
...
|Name|Description|
|:-|:-|
|Temporal|Once per turn, not including [held turns](/combat/round#term-hold-ap), you may reverse the effects of any abilities you used during your turn in order to regain all of your AP.|
...
|Organic|When you use a [status-inflicting ability](/combat/attacking-and-defending#term-status-inflicting-ability) while wielding this weapon, the roll to determine if the status hits is made as though the target's Resistance were one half its actual value, rounded down.|
