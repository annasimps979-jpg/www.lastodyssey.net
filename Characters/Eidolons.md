...
At the beginning of each round after an eidolon is summoned, their summoner must either spend 1 Anima to keep them on the field or else the Eidolon stops being summoned and the initiative order goes back to normal.  If the Eidolon drops to 0 HP, they are also unsummoned, and will revert back to 1 HP after the [battle](../Extras/Key-Terms#term-battle) is over.  When an Eidolon is unsummoned, whatever HP they had remains until it is healed by their character, but they lose all other effects once the battle is over, including buffs, debuffs, Shells, and status effects.
...
|Name|Type|Cost|Description|
|:-|:-|:-|:-|
|Heal|Ally|1 AP|Heal either the eidolon or a single [party](../Extras/Key-Terms#term-party) member by an amount equal to the eidolon's Magical Attack.  If the ally is downed, they are also revived.|
