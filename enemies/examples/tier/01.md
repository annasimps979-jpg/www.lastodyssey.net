...
In [combat](/combat), police will swap between [rounds](/combat/round#term-round) when they use their [debuffs](/combat/buffs-and-debuffs#term-debuff) and rounds where they exert maximum force.  During the first round of [battle](/extras/key-terms#term-battle), they will not attack but instead sit there and either inflict [statuses](/combat/statuses), use [buffs](/combat/buffs-and-debuffs#term-buff) and debuffs, and generally look menacing.
...
|:-|:-|:-|:-|
|Truncheon|[Melee](/combat/attacking-and-defending#term-melee)|1 AP|The Cop makes a [basic](/combat/round#term-basic-attack) [physical attack](/combat/attacking-and-defending#term-physical-attack).|
|Crowd Control|[Ranged](/combat/attacking-and-defending#term-ranged)|3 [MP](/characters/attributes-and-statistics#term-mp), 1 AP|The Cop moves a single target's Physical Attack down by one step on the [Bonus Tracker](/combat/buffs-and-debuffs#term-bonus-tracker).|
|Body Armor|[Passive](/combat/attacking-and-defending#term-passive)|N/A|The first time the Cop is hit by a physical attack, they do not take any damage.|
...
|Tear Gas|Ranged|7 MP, 1 AP|Inflicts the [Burned](/combat/statuses#term-burned) status on a single target with a successful [status-inflicting ability](/combat/attacking-and-defending#term-status-inflicting-ability).|
|Injection|[Ally](/combat/attacking-and-defending#term-ally-ability)|5 MP, 1 AP|Restores 4 HP to a single ally.|
...
|Autocannon|[Special](/combat/attacking-and-defending#term-special-ability)|1 AP|Makes a colorless, ranged physical attack against a single target.  The Spider Drone may only use this [ability](/extras/key-terms#term-ability) once per battle.|
|Disarm|Melee|1 AP|Makes a colorless physical attack that, if successful, causes the target to drop their weapon.  The target must then spend 1 AP on its [turn](/combat/round#term-turn) to pick it back up.|
...
|Faithful|Passive|N/A|If there is a Captain on the battlefield and they are hit by an attack that would otherwise [down](/combat/death-and-injury#term-downed) them, the Lieutenant is hit by the attack instead.|
...
|Tactical Retreat|Passive|N/A|If the Skirmisher becomes [Shellbroken](/combat/shells#term-shellbroken), it will [move](/combat/round#term-move) to the back row immediately for free.|
...
|Name|Type|Cost|Description|
|:-|:-|:-|:-|
|Firebomb|Ranged|1 AP, 5 MP|Makes a fire [magical attack](/combat/attacking-and-defending#term-magical-attack) against a single target.|
...
|Practical Joke|Ranged|1 AP, 7 MP|Makes a status-inflicting roll that, on a hit, inflicts the [Confused](/combat/statuses#term-confused) status on an enemy.|
...
|Charge|Special|1 AP, 5 MP|Makes a physical attack against an enemy in the back row.  Can only be done if there are no enemies in the [front row](/combat/starting#term-front-row).|
...
|Too Stupid to Die|Passive|N/A|If the Boar Rider is reduced to 0 HP, it will not die until the [Effect Phase](/combat/round#term-effect-phase) at the end of the round.|
...
|Ritual Circle|[Multi](/combat/attacking-and-defending#term-multi)|2 AP|Gives every ally excluding the Shaman the Sacrifice status.  Once the Ritual Circle is established, the Shaman can spend an additional AP to make one of its enemies part of it as well.|
