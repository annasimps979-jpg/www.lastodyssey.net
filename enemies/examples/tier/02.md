...
Forest Dwellers are interested in murdering their opponents with as little fanfare as possible.  The exception to this is that they will prioritize survival in [combat](/combat) over a quicker end to things.  You will see them choose to use healing [abilities](/extras/key-terms#term-ability) even when it isn't strictly needed, and playing it safe with [buffs](/combat/buffs-and-debuffs#term-buff) and [debuffs](/combat/buffs-and-debuffs#term-debuff).
...
|:-|:-|:-|:-|
|Bite|[Melee](/combat/attacking-and-defending#term-melee)|1 [AP](/combat/round#term-ap)|Makes a [basic](/combat/round#term-basic-attack) [physical attack](/combat/attacking-and-defending#term-physical-attack).|
|Gore|Melee|3 [MP](/characters/attributes-and-statistics#term-mp), 1 AP|Makes a [colorless](/combat/elemental-types#term-colorless) physical attack that inflicts damage multiplied by 1.5x in addition to other modifiers.|
|Howl|[Self](/combat/attacking-and-defending#term-self-ability)|3 MP, 1 AP|Buffs the Physical Attack of the Wolf by one step on the [Bonus Tracker](/combat/buffs-and-debuffs#term-bonus-tracker).|
...
|Entangle|[Ranged](/combat/attacking-and-defending#term-ranged)|1 AP, 7 MP|Uses a [status-inflicting ability](/combat/attacking-and-defending#term-status-inflicting-ability) that inflicts [Petrified](/combat/statuses#term-petrified) on a hit.|
|Photosynthesis|Passive|N/A|If the Dryad receives [water](/combat/elemental-types#term-water) damage, they will receive the damage as healed HP.  If the Dryad receives [light](/combat/elemental-types#term-light) damage, they will receive the damage as healed MP.|
...
|Baptize|[Ally](/combat/attacking-and-defending#term-ally-ability)|1 AP, 8 MP|Removes all buffs and debuffs from a single ally.|
...
|Tough Bark|Self|1 AP, 7 MP|Inflicts the Guarded [status](/combat/statuses) on the Ent until the beginning of its next [turn](/combat/round#term-turn) or until after the next time it is hit with a physical attack.|
|Regenerate|Self|1 AP, 11 MP|Heals the Ent for an amount of HP equal to twice its Magical Attack.|
|Photosynthesis|[Passive](/combat/attacking-and-defending#term-passive)|N/A|If the Ent receives water damage, they will receive the damage as healed HP.  If the Ent receives Light damage, they will receive the damage as healed MP.|
|Forest Fire|Passive|N/A|If the Ent takes [fire](/combat/elemental-types#term-fire) damage from any source, it will not be able to use Regenerate until after its next turn.|
...
|Name|Type|Cost|Description|
|:-|:-|:-|:-|
|Airslice|Ranged|1 AP, 5 MP|Makes a wind [magical attack](/combat/attacking-and-defending#term-magical-attack) against a single target.|
|Taunt|Ranged|1 AP|Works the same way as the Defender's Taunt.|
|Counterspell|[Reaction](/combat/attacking-and-defending#term-reaction)|Variable|Works the same way as a Sage's Counterspell.|
|Sparkles|Self|2 AP|Restores 10 MP to the Pixie.|
|Revenge Hex|Passive|N/A|When the Pixie is [downed](/combat/death-and-injury#term-downed), the character responsible must roll to resist [Silenced](/combat/statuses#term-silenced) versus the Pixie's Status Accuracy.|
