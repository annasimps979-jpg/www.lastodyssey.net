...
Invaders don't follow too many rules in [combat](/combat), except for one: do whatever the [players](/extras/key-terms#term-player) expect the least at any given time.
...
|:-|:-|:-|:-|
|Bite|[Melee](/combat/attacking-and-defending#term-melee)|1 AP|Makes a [basic](/combat/round#term-basic-attack) [physical attack](/combat/attacking-and-defending#term-physical-attack).|
|Acid Spit|[Ranged](/combat/attacking-and-defending#term-ranged)|1 AP, 5 [MP](/characters/attributes-and-statistics#term-mp)|Makes a [magical attack](/combat/attacking-and-defending#term-magical-attack) that deals magical [wood](/combat/elemental-types#term-wood) damage on a hit and also reduces the enemy's Physical Defense by one on the [Bonus Tracker](/combat/buffs-and-debuffs#term-bonus-tracker).|
|Accelerated Growth|[Passive](/combat/attacking-and-defending#term-passive)|N/A|During each [Effect Phase](/combat/round#term-effect-phase), the Grub's Magical Defense, Physical Defense, and Resistance are [buffed](/combat/buffs-and-debuffs#term-buff) by one on the Bonus Tracker.|
...
|Standard Shell|[Ally](/combat/attacking-and-defending#term-ally-ability)|1 AP, 7 MP|Increases or restores the Shell of the Pupil or one of its allies by 18 points.|
|Implant Eggs|[Special](/combat/attacking-and-defending#term-special-ability)|1 AP|If another character on the battlefield is already [downed](/combat/death-and-injury#term-downed), the Pupil can use this [ability](/extras/key-terms#term-ability) on them.  During the next Effect Phase, a Grub will spawn on the front line of the Pupil's side of the [battle](/extras/key-terms#term-battle).|
...
|Cloaking Field|[Self](/combat/attacking-and-defending#term-self-ability)|1 AP, 10 MP|This ability inflicts the Cloaked [status](/combat/statuses) on the Infiltrator, which works the same as the [Thief's](/characters/archetypes/thief) Hide ability.|
|Implant|Melee|1 AP, 5 MP|Uses a status-inflicting ability that, on a hit, deals physical colorless damage and inflicts the Athena status.  During the next Effect Phase, characters with the Athena status will have their Magical and Status Accuracies [debuffed](/combat/buffs-and-debuffs#term-debuff) by three steps on the Bonus Tracker.  A Grub will then spawn in the [front row](/combat/starting#term-front-row) on the Infiltrator's side and the Athena effect will be removed from the character.|
...
|Overwhelm|[Multi](/combat/attacking-and-defending#term-multi)|1 AP, 12 MP|Makes a physical attack against all of the Swarm's enemies that deals physical colorless damage on a hit.|
...
|Mass Delusion|Multi|1 AP, 18 MP|Uses a status-inflicting ability on all of the Illithid's enemies that inflicts the [Confused](/combat/statuses#term-confused) status on a hit.|
...
|Automatic Fire|Passive|N/A|The Trooper may make one more basic attack per spent AP per subsequent [turn](/combat/round#term-turn) it has used a basic attack during.|
...
|Jury-Rig|[Special](/combat/attacking-and-defending#term-special-ability)|1 AP, 11 MP|The Engineer can transfer up to a total HP, Shell, and MP from one of their allies to another equal to its Magical Attack, so long as they are Construct type [characters](/extras/key-terms#term-character).|
