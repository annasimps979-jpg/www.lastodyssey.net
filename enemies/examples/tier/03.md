...
In [combat](/combat), the living dead are stupid, aggressive, and totally unconcerned with death.  Insofar as they display cunning, it should purely be to create a sense of dramatic tension and to display animus towards the [player characters](/extras/key-terms#term-player).
...
|:-|:-|:-|:-|
|Smack|[Melee](/combat/attacking-and-defending#term-melee)|1 AP|Makes a [basic](/combat/round#term-basic-attack) [physical attack](/combat/attacking-and-defending#term-physical-attack).|
...
|Undeath|[Passive](/combat/attacking-and-defending#term-passive)|N/A|The first time the Zombie would be [downed](/combat/death-and-injury#term-downed) in a battle, it is reduced to 1 HP instead.  Any further damage it takes will cause it to become downed.|
...
|Arrow|[Ranged](/combat/attacking-and-defending#term-ranged)|1 AP, 5 MP|Makes a [colorless](/combat/elemental-types#term-colorless) physical attack against a single target.|
...
|Bonechill|Ranged|1 AP, 5 MP|Makes a [magical attack](/combat/attacking-and-defending#term-magical-attack) that does magical ice damage on a hit.|
|Cold Fingers|Ranged|1 AP, 7 MP|On a hit, inflicts [Frostbitten](/combat/statuses#term-frostbitten) on a single target.|
|Nostalgia|Ranged|1 AP, 12 MP|Uses a [status-inflicting ability](/combat/attacking-and-defending#term-status-inflicting-ability) that inflicts Slowed on a single target.|
|Immaterial|Passive|N/A|During the [Effect Phase](/combat/round#term-effect-phase), the Ghost will become Immaterial, which is the equivalent of Hidden.  At the beginning of their [turn](/combat/round#term-turn), this effect disappears.|
...
|:-|:-|:-|:-|
|Slash|Melee|1 AP|Makes a basic physical attack.|
|Hedgetrimmer|[Multi](/combat/attacking-and-defending#term-multi)|1 AP, 7 MP|Makes a basic physical attack against every enemy in the [front row](/combat/starting#term-front-row).  May only be used from the front row.|
|Shield|[Self](/combat/attacking-and-defending#term-self-ability)|1 AP, 7 MP|The next time the Statue is hit by a physical attack, the damage is negated.|
|Frontline|Self|1 AP, 10 MP|Inflicts the Guarded [status](/combat/statuses) on all of the Statue's allies until the beginning of its next turn.|
...
|Miasma|Passive|N/A|During the Effect Phase of each [round](/combat/round#term-round), the Zombie Hulk makes a status-inflicting ability roll with no AP or MP cost to inflict Poisoned on every non-Undead character on the battlefield.|
...
Void elves are powerful combatants, but are also quite arrogant.  As a result, they will fight with intelligence, but will often disregard their enemies' defenses or [buffs](/combat/buffs-and-debuffs#term-buff), assuming that their raw power is enough to prevail.  They will, of course, still [debuff](/combat/buffs-and-debuffs#term-debuff) their enemies when they want to prove a point.
...
|Mindspike|Ranged|1 AP, 5 MP|Makes a magical [light](/combat/elemental-types#term-light) attack against a single enemy.|
|Corrupt Mind|Ranged|1 AP, 10 MP|Debuffs an enemy's Magical Attack by 3 steps on the [Bonus Tracker](/combat/buffs-and-debuffs#term-bonus-tracker).|
...
|Mass Anchor|Ranged|1 AP, 7 MP|Attempts to inflict [Fatigued](/combat/statuses#term-fatigued) on a single enemy using a status-inflicting ability.|
|Push/Pull|Ranged|1 AP, 5 MP|Makes a status-inflicting ability roll.  On a hit, the Telekinetic can force a single enemy to use the [Move](/combat/round#term-move) [action](/extras/key-terms#term-action) at no AP cost, unless said enemy is immune to effects that move them.|
