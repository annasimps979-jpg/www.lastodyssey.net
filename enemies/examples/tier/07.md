...
In [combat](/combat), Orks want to strike terror in the hearts of their enemies.  They do this through doing their best to do massive amounts of physical damage, and by purposefully ignoring their own health to maintain their image as invulnerable, rage-filled monsters.
...
|:-|:-|:-|:-|
|Axe|[Melee](/combat/attacking-and-defending#term-melee)|1 AP|Makes a [basic](/combat/round#term-basic-attack) [physical attack](/combat/attacking-and-defending#term-physical-attack).|
|Two-Handed Chop|Melee|1 AP, 5 [MP](/characters/attributes-and-statistics#term-mp)|Makes a physical attack that, on a hit, does [colorless](/combat/elemental-types#term-colorless) physical damage that is multiplied by 2 in addition to other modifiers.|
|Disposable|[Passive](/combat/attacking-and-defending#term-passive)|N/A|Fodder will always take damage for any non-Fodder enemies on the battlefield.  If there are multiple Fodder enemies on the battlefield, the GM may choose which one takes the damage.|
...
|Boom|[Ranged](/combat/attacking-and-defending#term-ranged)|1 AP, 9 MP|Makes a [magical attack](/combat/attacking-and-defending#term-magical-attack) against a single enemy that, on a hit, deals magical earth damage that is multiplied by 2 in addition to other multipliers.|
|Tripwire|[Special](/combat/attacking-and-defending#term-special-ability)|1 AP, 5 MP|The next one of the Goblin's enemies to [move](/combat/round#term-move) will automatically gain the [Petrified](/combat/statuses#term-petrified) status unless they are immune to it.  Only one Tripwire can be present on the battlefield at a time.  If the Goblin is [downed](/combat/death-and-injury#term-downed), the Tripwire leaves.|
...
|Fury|[Self](/combat/attacking-and-defending#term-self-ability)|1 AP|Works the same way as the [Knight's](/characters/archetypes/knight) Focus [ability](/extras/key-terms#term-ability) when the Knight has the Melee passive ability active.|
|Cleave|[Multi](/combat/attacking-and-defending#term-multi)|1 AP, 7 MP|The Berserker makes a melee physical attack against every character in the [front row](/combat/starting#term-front-row).  On a hit, this attack does colorless physical damage.|
...
|Adaptation|Passive|N/A|When the Cave Troll is hit by a physical attack, their Physical Defense is [buffed](/combat/buffs-and-debuffs#term-buff) by one step on the [Bonus Tracker](/combat/buffs-and-debuffs#term-bonus-tracker) and their Magical Defense is [debuffed](/combat/buffs-and-debuffs#term-debuff) by one step on the Bonus Tracker.  When the Cave Troll is hit by a magical attack, the reverse happens.|
...
|Repression|Multi|1 AP, 18 MP|Uses a [status-inflicting ability](/combat/attacking-and-defending#term-status-inflicting-ability) on all of the Bleak Lord's enemies that inflicts [Silenced](/combat/statuses#term-silenced) on a hit.|
...
|Cigar Toss|Ranged|1 AP, 7 MP|Uses a status-inflicting ability that, on a hit, inflicts the Burned [status](/combat/statuses) on a single target.|
...
|Contract|Special|1 AP|The Cambion selects an enemy for a contract.  If they agree, the Cambion will expend 11 MP and the enemy will be healed for 20 HP.  If the Cambion is still standing during the Effect Phase of the following [round](/combat/round#term-round), that same enemy will take 40 damage.|
