...
In [combat](/combat), the lives of Elite dragons are much more valuable than those of their Normal servants, meaning that the latter will gladly sacrifice themselves for the former.
...
|:-|:-|:-|:-|
|Slash|[Melee](/combat/attacking-and-defending#term-melee)|1 AP|Makes a [basic](/combat/round#term-basic-attack) [physical attack](/combat/attacking-and-defending#term-physical-attack).|
|Thrust|Melee|1 AP, 3 [MP](/characters/attributes-and-statistics#term-mp)|Makes a physical attack that deals [colorless](/combat/elemental-types#term-colorless) physical damage that is multiplied by 1.5 in addition to other modifiers.|
|Strength in Numbers|[Passive](/combat/attacking-and-defending#term-passive)|N/A|During the [Effect Phase](/combat/round#term-effect-phase), the Drakeling's Physical Defense and Magical Defense are [buffed](/combat/buffs-and-debuffs#term-buff) by a number of steps on the [Bonus Tracker](/combat/buffs-and-debuffs#term-bonus-tracker) equal to the number of other Drakelings still not [downed](/characters/attributes-and-statistics#term-downed) on the battlefield.|
...
|Treat Wound|[Ally](/combat/attacking-and-defending#term-ally-ability)|1 AP, 11 MP|Heals a single ally by an amount of HP equal to twice the Attendant's Magical Attack.|
|Treat Disease|Ally|1 AP, 12 MP|Removes all [statuses](/combat/statuses) from a single target.|
...
|Gravitational Collapse|[Ranged](/combat/attacking-and-defending#term-ranged)|1 AP, 10 MP|Makes a [magical attack](/combat/attacking-and-defending#term-magical-attack) that deals magical earth damage on a hit.  Every time this attack breaks an enemy's Shell, the Scholar is able to make another magical attack against another target for free.|
|Read the Bones|[Self](/combat/attacking-and-defending#term-self-ability)|1 AP, 15 MP|The next attack the Scholar makes cannot miss.|
...
|Thunder Breath|[Multi](/combat/attacking-and-defending#term-multi)|1 AP, 15 MP|Makes a physical attack against all of the Warrior's enemies that does physical thunder damage on a hit.|
|Basilisk|Multi|1 AP, 18 MP|Uses a [status-inflicting ability](/combat/attacking-and-defending#term-status-inflicting-ability) on all of the Warrior's enemies that inflicts [Petrified](/combat/statuses#term-petrified) on a hit.|
...
|Manipulate Fate|Multi|1 AP, 30 MP|[Debuffs](/combat/buffs-and-debuffs#term-debuff) the Physical, Magical, and Status Accuracy of all of the Oracle's enemies.|
|Reset Timeline|[Special](/combat/attacking-and-defending#term-special-ability)|2 AP|The Oracle uses the [Harlequin's](/characters/archetypes/harlequin) Jubilee [ability](/extras/key-terms#term-ability).|
...
|Name|Type|Cost|Description|
|:-|:-|:-|:-|
|Fire Missile|Ranged|1 AP, 9 MP|Makes a magical attack against a single target that deals magical [fire](/combat/elemental-types#term-fire) damage on a hit that is multiplied by 2 in addition to other modifiers.|
|Water Missile|Ranged|1 AP, 9 MP|Makes a magical attack against a single target that deals magical [water](/combat/elemental-types#term-water) damage on a hit that is multiplied by 2 in addition to other modifiers.|
...
|Uncanny Movement|Passive|N/A|When the Homonculus makes a physical attack, the [GM](/extras/key-terms#term-gm) should roll the [hit die](/combat/attacking-and-defending#term-hit-die) twice and choose the result they take.|
