...
## Angels
The servants of Heaven are just and righteous, but this makes them no less deadly in [combat](/combat).
...
|:-|:-|:-|:-|
|Strike|[Melee](/combat/attacking-and-defending#term-melee)|1 AP|Makes a [basic](/combat/round#term-basic-attack) [physical attack](/combat/attacking-and-defending#term-physical-attack).|
|Behold!|[Multi](/combat/attacking-and-defending#term-multi)|1 AP, 18 [MP](/characters/attributes-and-statistics#term-mp)|Uses a [status-inflicting ability](/combat/attacking-and-defending#term-status-inflicting-ability) on all of the Herald's enemies that inflicts the [Blinded](/combat/statuses#term-blinded) [status](/combat/statuses) on a hit.|
|The First Seal|[Passive](/combat/attacking-and-defending#term-passive)|N/A|When the Herald is [downed](/combat/death-and-injury#term-downed), all of the Herald's enemies have their Magical Accuracy [debuffed](/combat/buffs-and-debuffs#term-debuff) by one step on the [Bonus Tracker](/combat/buffs-and-debuffs#term-bonus-tracker).|
...
|Arrow of Light|[Ranged](/combat/attacking-and-defending#term-ranged)|1 AP, 8 MP|Makes a physical attack against a single target that deals physical light damage on a hit.|
|Inscrutable Form|Passive|N/A|The Seeker does not take double damage from physical or [magical attacks](/combat/attacking-and-defending#term-magical-attack) depending on whether or not its shell or HP are being damaged.  All other multipliers still apply.|
...
|Light Barrier|[Self](/combat/attacking-and-defending#term-self-ability)|1 AP, 20 MP|The Protector inflicts the Light Barrier status on themselves.  The next time a [character](/extras/key-terms#term-character) hits them with a magical or physical attack, the Protector uses a status-inflicting ability for free that causes their attacker to become [Blinded](/combat/statuses#term-blinded) on a hit.|
...
|Bloodthirst|[Reaction](/combat/attacking-and-defending#term-reaction)|N/A|When one of the Ghoul's enemies is downed, the Ghoul can immediately use Relentless Attack on a single enemy within range without spending any AP.  If there are no enemies within range, this effect does not apply.|
...
|True Vampire|Passive|N/A|The Elder is immune to all magical damage that it is not weak to due to its [elemental type](/combat/elemental-types#term-elemental-type).|
...
|Entrance|Special|1 AP, 5 MP|Uses a status-inflicting ability that, if it hits, inflicts the Entranced status effect.  Entranced characters cannot act.|
|It Keeps Coming Back|Passive|N/A|When the Wight is downed, the [GM](/extras/key-terms#term-gm) should roll the outcome die.  If the roll is a 3 or below, the Wight will be revived at full HP and Shell during the [Effect Phase](/combat/round#term-effect-phase) of the same round in which it was downed.|
