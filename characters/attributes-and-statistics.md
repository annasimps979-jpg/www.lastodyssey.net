...
The capabilities of a [character](/extras/key-terms#term-character) during [battle](/extras/key-terms#term-battle) are represented by their [statistics](/extras/key-terms#term-statistic) and their [abilities](/extras/key-terms#term-ability).  [Player characters](/extras/key-terms#term-player-character) also have a set of three numbers called [attributes](/extras/key-terms#term-attribute) that determine what they can do in and out of combat. The abilities a player character can use are determined by the [job](/characters/jobs) they occupy and its current rank, their [archetype](/characters/archetypes), their [items](/economy/items), their [equipment](/economy/equipment), and whatever [flex powers](/characters/advancement#term-flex-power) they have taken during [character advancement](/characters/advancement).
...
*  A character's _Resistance_ increases the likelihood that they will resist [status-inflicting abilties](/combat/attacking-and-defending#term-status-inflicting-ability).  Their base Resistance is equal to the bonus from their equipped accessories plus the bonus from their current job if there is one.
