...
*  An enemy's _tier_ indirectly determines their combat statistics by setting the number of [attribute](../Extras/Key-Terms#term-attribute) points available to allocate to determine their statistics.
*  _Aggression_ is a measure of how vicious an enemy is in melee combat, and contributes to an enemy's [Physical Attack](../Characters/Attributes-and-Statistics#term-physical-attack), [Initiative](../Characters/Attributes-and-Statistics#term-initiative), and [Physical Accuracy](../Characters/Attributes-and-Statistics#term-physical-accuracy).
