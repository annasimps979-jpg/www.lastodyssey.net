...
*  As a [Support](/srd/heroes/roles/support), their [charm](/srd/combat/glamors#term-charm) [abilities](/srd/glossary#term-ability) affect [Status Accuracy](/srd/heroes/numbers#term-status-accuracy).
*  As a [Saboteur](/srd/heroes/roles/saboteur), their [hex](/srd/combat/glamors#term-hex) abilities affect [Physical Accuracy](/srd/heroes/numbers#term-physical-accuracy).
...
**Saboteur:** Random Hex.  When the Harlequin uses a hex, their player may cast on the Random Statistic Table to determine which statistic the ability affects.
