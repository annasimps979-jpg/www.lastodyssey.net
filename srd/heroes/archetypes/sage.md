...
|Name|Type|Cost|Description|
|:-|:-|:-|:-|
|Ascension|[Self](/srd/combat/attacking-and-defending#term-self-ability)|1 [Anima](/srd/anima#term-anima), 2 AP|Your Spell Slots and MP are immediately refilled to full.  For the rest of the [battle](/srd/key-terms#term-battle), your magical attacks only cost 5 MP.|

## Talents

**[Striker](/srd/heroes/roles/striker):** Martial Artist.  You may also expend Spell Slots in order to use [physical attacks](/srd/combat/attacking-and-defending#term-physical-attack).

**[Caster](/srd/heroes/roles/caster):** Empowered Staff.  Your Elemental Bolt ability does not cost any MP.

**[Healer](/srd/heroes/roles/healer):** Alchemy.  You may expend Spell Slots in order to use your Healer abilities.

**[Defender](/srd/heroes/roles/defender):** Arcane Shield.  You may use Counterspell to negate enemy physical attacks.  Negating an enemy's [basic attack](/srd/combat/round#term-basic-attack) costs 5 MP.
