...
|Name|Type|Cost|Description|
|:-|:-|:-|:-|
|Assassinate|Melee|1 [Anima](/srd/anima#term-anima), 2 AP|Select an enemy and cast the [outcome die](/srd/key-terms#term-outcome-die).  That enemy loses a percentage of their remaining combined [HP](/srd/heroes/attributes-and-statistics#term-hp) and [Shell](/srd/combat/shells) equal to the result on the die multiplied by 10.  Antagonists cannot be reduced below 1 HP by this ability.|

## Talents

**[Striker](/srd/heroes/roles/striker):** Lifesteal.  When you use Steal on an enemy and the result of the die is a 4, you drain an amount of HP from them equal to your current Physical Attack and give it to yourself.

**[Caster](/srd/heroes/roles/caster):** Manasteal.  When you use Steal on an enemy and cast a 4 on their item table, you drain an amount of [MP](/srd/heroes/attributes-and-statistics#term-mp) from them equal to your current [Magical Attack](/srd/heroes/attributes-and-statistics#term-magical-attack) and give it to yourself.

**[Healer](/srd/heroes/roles/healer):** Night Shift.  You may use your Healer abilities while Hidden without removing the status from yourself.

**[Defender](/srd/heroes/roles/defender):** Ninja Bodyguard.  You may use Guard, Shield, Counter, and Reflect without losing the Hidden status.  If any of the effects of these abilities are triggered while you are Hidden, you lose the Hidden status.

**Support:** Shellsteal.  When you use Steal on an enemy and receive a 4 on their item table, you drain an amount of Shell from them equal to your current Magical Attack and give it to yourself.  Your current Shell will then become the [elemental type](/srd/combat/elemental-types#term-elemental-type) of the drained Shell.

**Saboteur:** Infection.  When you use Steal on an enemy and receive a 4 on their item table, you inflict the status on them associated with your elemental type.  If they are immune to this status, this talent does not apply.
