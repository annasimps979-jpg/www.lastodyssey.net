...
|Flex Bolt|Ranged|10 MP, 1 AP|When a player first chooses this power during advancement, they must choose a non-[colorless](/srd/combat/elemental-types#term-colorless) [elemental type](/srd/combat/elemental-types#term-elemental-type).  Using this ability uses a [spell](/srd/combat/attacks#term-spell) of that elemental type against a single target.|
|Flex Strike|[Melee](/srd/combat/attacks#term-melee)|10 MP, 1 AP|When a player first chooses this power during advancement, they must choose a non-colorless elemental type.  Using this ability makes a [strike](/srd/combat/attacks#term-strike) of that elemental type against a single target.|
|Flex Debilitate|Ranged|14 MP, 1 AP|When a player first chooses this power during advancement, they must choose a [status](/srd/combat/statuses) with an elemental type.  Using this ability triggers a [sleight](/srd/combat/attacks#term-sleight) against a single target that inflicts this status on a hit.|
|Flex Shell|Ally|14 MP, 1 AP|When a player first chooses this power during advancement, they must choose a non-colorless elemental type.  Using this ability increases the [Shell](/srd/combat/shells) of a single target by the user's current [Magical Attack](/srd/heroes/attributes-and-statistics#term-spell).  This power works the same as the [Support's](/srd/heroes/roles/support) Shell ability.|
