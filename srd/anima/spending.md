...
*  During travel, they may spend 1 Anima to automatically succeed when [pathfinding](/srd/exploration/travel/round#term-pathfinding).
*  In combat, they can spend 3 Anima to take the [Summon Eidolon](/srd/combat/round#term-summon-eidolon) [action](/srd/glossary#term-action).
*  In combat, they must spend 1 Anima per round to keep their eidolon on the field.
*  In combat, they may spend 1 Anima to turn any die result into either a 1 or a 10, with the exception of [calling Initiative](/srd/combat/starting#term-calling-initiative).
*  In and out of combat, they can spend 3 Anima to save themselves from True Death.  If so, they will be revived at 1 [HP](/srd/heroes/numbers#term-hp) during the [Paradigm Phase](/srd/combat/round#term-paradigm-phase) of the following round, or after a making contact with their eidolon if they are not in combat.  They must do this at the moment of their own death, and they cannot intervene to save any other characters but themselves.  If a Hero saves themselves from True Death after dying due to a [Scene](/srd/anima/scenes), no Anima is earned as a result of the Scene.
...
Every time any character, Hero or otherwise, uses Anima and it is not transferred to a character that can already use Anima, the GM add how much was used to a running tally called the _<dfn id = "term-anima-pool">Anima Pool</dfn>_ that is hidden from all participants except the GM.  When Heroes earn Anima from [Scenes,](/srd/anima/scenes) this score drops by the amount that was earned.  When the GM creates a new Antagonist, they may give them starting Anima that is then removed from this tally, up to the character maximum of 10.  No matter what, the Anima Pool can never go below 0.  Note that the GM still has the freedom to introduce Antagonists whenever they feel is appropriate.
