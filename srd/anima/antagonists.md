...
Some of the enemies that the [players](/srd/key-terms#term-player) face are more powerful than ordinary opponents, and can use [Anima](/srd/anima#term-anima) to break the normal rules of gameplay.  In Last Odyssey, these enemies are referred to as _<dfn id = "term-antagonist">Antagonists</dfn>._  There are two major types of Antagonists:
