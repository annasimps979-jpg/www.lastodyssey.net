...
Some of the warriors that the [players](/srd/glossary#term-player) face are more powerful than ordinary opponents, and can use [Anima](/srd/anima#term-anima) to break the normal rules of gameplay.  In Last Odyssey, these warriors are referred to as _<dfn id = "term-antagonist">Antagonists</dfn>._  There are two major types of Antagonists:
