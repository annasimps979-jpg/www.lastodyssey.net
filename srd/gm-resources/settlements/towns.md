...
A _<dfn id = "term-town">town</dfn>_ is the next largest type of settlement after a [village](/srd/gm-resources/settlements/villages).  What distinguishes a town from a village is not just its size but also its purpose.  The reason why towns exist in the first place is to facilitate commerce, and as a result town residents will often hold jobs that are provided for by the flow of trade rather than the direct production of foodstuffs.  A town's markets and taverns are gathering spaces where craftspeople can sell their goods, farmers can sell their produce, professionals can ply their trades, and ideologues of all sorts can attempt to sway people to their causes.  Towns are the best place to find services and learn about local events, but most residents will still be ignorant of regional news beyond the broad strokes.  Larger [cities](/srd/gm-resources/settlements/cities) will often have clusters of satellite towns near their limits, while in more rural areas the largest settlement will take the form of a single town.
...
[GMs](/srd/extras/key-terms#term-gm) should consider the following questions when designing a town:
*  Towns are large enough to accommodate a great deal of complex politics.  What is the latest drama?  Is there a way for the [players](/srd/extras/key-terms#term-player) to get involved, and if so, how?
