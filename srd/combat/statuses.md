...
|[Water](/srd/combat/elements#term-water)|<dfn id = "term-confused">Confused</dfn>|When a Confused character uses an ability with a target other than themselves, the [GM](/srd/glossary#term-gm) flips a coin and has them call heads or tails.  If they call correctly, their ability is used on the intended target.  If they call incorrectly, the GM chooses the target of their ability instead.  If a warrior is Confused, the role of the player and GM are reversed.|
