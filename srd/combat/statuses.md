...
|[Water](/srd/combat/elements#term-water)|<dfn id = "term-confused">Confused</dfn>|When a Confused character uses an ability with a target other than themselves, the [GM](/srd/glossary#term-gm) flips a coin and has them call heads or tails.  If they call correctly, their ability is used on the intended target.  If they call incorrectly, the GM chooses the target of their ability instead.  If an enemy is Confused, the role of the player and GM are reversed.|
|[Earth](/srd/combat/elements#term-earth)|<dfn id = "term-petrified">Petrified</dfn>|The affected character is unable to use the [Move](/srd/combat/round#term-move) action, and their [base](/srd/glossary#term-base) [Evasion](/srd/heroes/numbers#term-evasion) counts as being half its current value rounded down, not including buffs and [debuffs](/srd/combat/buffs-and-debuffs#term-debuff).  They may still advance as normal.|
