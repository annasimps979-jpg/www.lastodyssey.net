...
|[Water](/srd/combat/elements#term-water)|<dfn id = "term-confused">Confused</dfn>|When a Confused character uses an ability with a target other than themselves, the [GM](/srd/glossary#term-gm) flips a coin and has them call heads or tails.  If they call correctly, their ability is used on the intended target.  If they call incorrectly, the GM chooses the target of their ability instead.  If one of the party's opponents is Confused, the roles of the player and GM are reversed in this regard.  If no one at the table has a coin, the group may cast a die to simulate one instead.|
