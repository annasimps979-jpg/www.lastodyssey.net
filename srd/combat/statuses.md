...
|:-|:-|:-|
|[Fire](/srd/combat/elements#term-fire)|<dfn id = "term-burned">Burned</dfn>|The affected character cannot receive any healing and cannot be [charmed](/srd/combat/glamors#term-charm) while this status is active.  Any charms they have already received remain active until otherwise removed.|
|[Water](/srd/combat/elements#term-water)|<dfn id = "term-confused">Confused</dfn>|When a Confused character uses an ability with a target other than themselves, the [GM](/srd/glossary#term-gm) flips a coin and has them call heads or tails.  If they call correctly, their ability is used on the intended target.  If they call incorrectly, the GM chooses the target of their ability instead.  If an warrior is Confused, the role of the player and GM are reversed.|
