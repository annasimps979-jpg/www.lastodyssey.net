...
Heroes, enemies, [eidolons](/srd/heroes/eidolons#term-eidolon), and many [abilities](/srd/key-terms#term-ability) all have an extra property called their _<dfn id = "term-elemental-type">elemental type</dfn>._  Setting wise, think of elemental type as the form in which magic is expressed.  There are nine elemental types:
