...
When <abbr title="game master">GM</abbr>s decide to include one or more cities in a given region, they should take into consideration the following questions:
