...
Any item that is not useful for combat or exploration and cannot be represented by [<abbr title = "currency">¤</abbr>](/srd/economy/currency#term-cr) is referred to as _<dfn id = "term-junk">junk</dfn>._  Junk items include pots and pans, broken tools or weapons, bags of rocks, or anything else the Heroes pick up along their journey.  When determining the Weight of a piece of junk, use the same heuristic as for creating items using [Supplies](/srd/economy/travel#term-supplies).