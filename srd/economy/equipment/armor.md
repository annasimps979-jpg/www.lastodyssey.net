...
Unique armor does not have a cost, as it is not for sale and each set is the only one of its kind in the entire campaign world.
...
|Status Resistance|While a character is wearing this armor, the probability of an enemy inflicting a particular [status](/srd/combat/statuses) on them is reduced as though they were resistant to the effect's element.  This upgrade does not stack, but they can resist multiple statuses at once with different versions of this upgrade.|
...
|Vengeful|When the wearer takes physical damage due to an enemy's attack while wearing this armor, the enemy immediately also becomes the target of their own strike as though they were the target of the attack.|
