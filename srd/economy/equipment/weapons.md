...
|Name|Description|
|:-|:-|
|Reach|This weapon's Melee abilities can hit warriors in the [back row](/srd/combat/starting#term-back-row) or the [front row](/srd/combat/starting#term-front-row) while the wielder is in the front row, and can also hit warriors in the front row while the wielder is in the back row.|
