...
|Slayer|When the wielder hits a target of the [creature type](/srd/targets/types#term-creature-type) specified by this upgrade, the damage is multiplied by 1.5x in addition to other modifiers.  This upgrade cannot stack, but there can be multiple Slayer upgrades of different types on the same weapon.|
