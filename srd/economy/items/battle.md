...
|Inflict Status|12 cr|When you use this item, make a [status-inflicting ability](/srd/combat/attacking-and-defending#term-status-inflicting-ability) roll against the target's [Resistance](/srd/characters/attributes-and-statistics#term-resistance) to determine whether or not the specified [status](/srd/combat/statuses) is inflicted.  If the item is Mundane, do not subtract anything from the roll.  If the item is Rare, subtract 2 from the roll, and if the Expert then subtract 5 from the roll.|
...
|Effect|Base Cost|Description|
|:-|:-|:-|
|Scan|10 cr|This item applies the [Artificer's](/srd/characters/archetypes/artificer) Scan ability to a single target, revealing all current relevant information about it.|
...
|Haste|800 cr|The target of this item becomes [Hasted](/srd/characters/jobs/support).  This still cannot stack with any other applications of Hasted.|
|Slow|900 cr|The target of this item becomes [Slowed](/srd/characters/jobs/saboteur).  This still cannot stack with any other applications of Slowed.|
...
|Random|When you use this item, it inflicts a random effect based on the element you roll on the [Random Element Table](/srd/extras/random-tables#term-random-element-table).|
...
|Experimental Combat Stim|Expert|Buff [Physical Attack](/srd/characters/attributes-and-statistics#term-physical-attack)/Buff [Physical Accuracy](/srd/characters/attributes-and-statistics#term-physical-accuracy)|Dual|9000 cr|
