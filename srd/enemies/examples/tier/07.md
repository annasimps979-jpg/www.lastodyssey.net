...
|Fury|[Self](/srd/combat/attacking-and-defending#term-self-ability)|1 AP|Works the same way as the [Knight's](/srd/characters/archetypes/knight) Focus [ability](/srd/extras/key-terms#term-ability) when the Knight has the Melee passive ability active.|
...
In combat, devils are clever and efficient.  While they are cruel, it is not to the point of impeding their ability to win.  They will use tactics on par with the [player characters](/srd/extras/key-terms#term-player-character).
...
|Hat Trick|Ranged|1 AP, 10 MP|The Imp makes a magical attack against a single opponent that allows them to steal an item from the [party](/srd/extras/key-terms#term-party) inventory.  They may then use this item with the Use Item action.|
...
|Charm|Ranged|1 AP, 7 MP|Uses a status-inflicting ability on a single target that inflicts the Charmed status on a hit.  During the [Effect Phase](/srd/combat/round#term-effect-phase), the [GM](/srd/extras/key-terms#term-gm) should roll the [outcome die](/srd/extras/key-terms#term-outcome-die).  If the roll is above a 7, any Charmed [characters](/srd/extras/key-terms#term-character) on the battlefield will take an extra [action](/srd/extras/key-terms#term-action) of the GM's choice.|
