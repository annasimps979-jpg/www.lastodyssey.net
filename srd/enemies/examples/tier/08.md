...
Angels will fight fair, but will also fight hard, and to the death.  If they are sent after the [players](/srd/extras/key-terms#term-player), this means they know their tactics and their weaknesses and are prepared to respond accordingly.
...
|Light Barrier|[Self](/srd/combat/attacking-and-defending#term-self-ability)|1 AP, 20 MP|The Protector inflicts the Light Barrier status on themselves.  The next time a [character](/srd/extras/key-terms#term-character) hits them with a magical or physical attack, the Protector uses a status-inflicting ability for free that causes their attacker to become [Blinded](/srd/combat/statuses#term-blinded) on a hit.|
...
|Entrance|Special|1 AP, 5 MP|Uses a status-inflicting ability that, if it hits, inflicts the Entranced status effect.  Entranced characters cannot act.|
|It Keeps Coming Back|Passive|N/A|When the Wight is downed, the [GM](/srd/extras/key-terms#term-gm) should roll the outcome die.  If the roll is a 3 or below, the Wight will be revived at full HP and Shell during the [Effect Phase](/srd/combat/round#term-effect-phase) of the same round in which it was downed.|
