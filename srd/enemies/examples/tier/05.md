...
|:-|:-|:-|:-|
|Slash|Melee|1 AP|Makes a basic physical attack.|
|Tactics|Ally|1 AP|The Infantry gives 1 AP to another [character](/srd/extras/key-terms#term-character) on the battlefield that said character can use immediately.  The Infantry can do this up to once per [turn](/srd/combat/round#term-turn).|
