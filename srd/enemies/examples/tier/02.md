...
|Gore|Melee|3 [MP](/srd/heroes/attributes-and-statistics#term-mp), 1 AP|Makes a [colorless](/srd/combat/elemental-types#term-colorless) physical attack that inflicts damage multiplied by 1.5x in addition to other modifiers.|
...
|Assassin's Mark|Ranged|1 AP|Applies the Hunted status to a single enemy.  Works the same as the [Ranger's](/srd/heroes/archetypes/ranger) Mark Target ability.|
