...
[GMs](/srd/extras/key-terms#term-gm) who want to introduce enemies not included in the [Example Enemies](/srd/enemies/examples) section have a few options.  First, they could take a pre-existing enemy and change it superficially, either by altering its creature or [elemental types](/srd/combat/elemental-types#term-elemental-type) and the elemental types of its [abilities](/srd/extras/key-terms#term-ability) and then changing its name and appearance.  They could also take an existing enemy and change its abilities.  Whatever the GM decides, it is recommended that they not hew too closely to any one roster of "canon" enemies.  This is partially to maintain the sense of danger and discovery for [players](/srd/extras/key-terms#term-player), and partially because learning about the abilities and [statistics](/srd/extras/key-terms#term-statistic) of the enemies that [player characters](/srd/extras/key-terms#term-player-character) will face on the road is a core part of the experience of Last Odyssey.

## Enemy Properties

*  The _<dfn id = "term-enemy-type">enemy type</dfn>_ of an enemy is a measure of its power relative to its [tier](/srd/characters/creation#term-tier).  _<dfn id = "term-normal-enemy">Normal</dfn>_ enemies are about as powerful as a player character, _<dfn id = "term-elite-enemy">Elite</dfn>_ enemies are a match for the entire [party](/srd/extras/key-terms#term-party), and _Antagonists_ are powerful bosses that are a serious challenge for any party.
...
*  An enemy's _tier_ indirectly determines their [combat](/srd/combat) [statistics](/srd/characters/attributes-and-statistics#term-statistic) by setting the number of [attribute](/srd/extras/key-terms#term-attribute) points available to allocate to determine their statistics.
*  _Aggression_ is a measure of how vicious an enemy is in close quarters, and contributes to an enemy's [Physical Attack](/srd/characters/attributes-and-statistics#term-physical-attack), [Initiative](/srd/characters/attributes-and-statistics#term-initiative), and [Physical Accuracy](/srd/characters/attributes-and-statistics#term-physical-accuracy).
*  _Toughness_ is a measure of how much damage an enemy can take, and contributes to an enemy's [Physical Defense](/srd/characters/attributes-and-statistics#term-physical-defense), [Resistance](/srd/characters/attributes-and-statistics#term-resistance), and [Health](/srd/characters/attributes-and-statistics#term-health).
*  _Magic_ is a measure of how adept an enemy is at dealing with magic, and contributes to an enemy's [Magical Attack](/srd/characters/attributes-and-statistics#term-magical-attack), [Magical Defense](/srd/characters/attributes-and-statistics#term-magical-defense), [Magical Accuracy](/srd/characters/attributes-and-statistics#term-magical-accuracy), and [Mana](/srd/characters/attributes-and-statistics#term-mana).
*  _Cunning_ is a measure of how clever and evasive an enemy is, and contributes to an enemy's [Evasion](/srd/characters/attributes-and-statistics#term-evasion), [Magical Accuracy](/srd/characters/attributes-and-statistics#term-magical-accuracy), and [Status Accuracy](/srd/characters/attributes-and-statistics#term-status-accuracy), and [Initiative](/srd/characters/attributes-and-statistics#term-initiative).

## Setting Attributes

When creating a new enemy, the GM must spend a fixed amount of points on each of these attributes that depends on the enemy's tier and its enemy type.  At tier 1, Normal enemies have 6 points to distribute, Elite enemies have 8, and each [Form](/srd/enemies/antagonists#term-form) of an Antagonist has 10.  Each additional tier grants 2 more points to Normal enemies, 3 more points to Elite enemies, and 4 more points to Antagonists.  The minimum value that an enemy can have in each of their attributes is 0.  The maximum value that a Normal enemy can have in a given attribute is 10, the maximum value an Elite can have is 15, and the maximum that an Antagonist can have is 20.  In addition to attribute points, the Health, Mana, and Initiative of all enemies are adjusted by a number called the enemy's _<dfn id = "term-tier-multiplier">tier multiplier</dfn>._  The tier multipliers for a Normal enemy are 5 for their Health and Mana and 1 for their Initiative, Elites have multipliers of 10 for their Health and Mana and 2 for their Initiative, and Antagonists have 20 for their Health and Mana and 2 for their Initiative.
