...
[GMs](/srd/glossary#term-gm) who want to introduce enemies not included in the [Example Enemies](/srd/enemies/examples) section have a few options.  First, they could take a pre-existing enemy and change it superficially, either by altering its creature or [elements](/srd/combat/elements#term-element) and the elements of its [abilities](/srd/glossary#term-ability) and then changing its name and appearance.  They could also take an existing enemy and change its abilities.  Whatever the GM decides, it is recommended that they not repeat the same enemy too many times.  This is partially to maintain the sense of danger and discovery for [players](/srd/glossary#term-player), and partially because learning about the abilities and [statistics](/srd/glossary#term-statistic) of the enemies that [Heroes](/srd/glossary#term-hero) will face on the road is a core part of the experience of Last Odyssey.
...
*  An enemy's _element_ determines the damage that different elemental attacks do to them.
*  An enemy's _tier_ indirectly determines their [combat](/srd/combat) [statistics](/srd/heroes/numbers#term-statistic) by setting the number of [attribute](/srd/glossary#term-attribute) points available to allocate to determine their statistics.
*  _Aggression_ is a measure of how vicious an enemy is in close quarters, and contributes to an enemy's [Physical Attack](/srd/heroes/numbers#term-strike), [Initiative](/srd/heroes/numbers#term-initiative), and [Physical Accuracy](/srd/heroes/numbers#term-physical-accuracy).
*  _Toughness_ is a measure of how much damage an enemy can take, and contributes to an enemy's [Physical Defense](/srd/heroes/numbers#term-physical-defense), [Resistance](/srd/heroes/numbers#term-resistance), and [Health](/srd/heroes/numbers#term-health).
*  _Magic_ is a measure of how adept an enemy is at dealing with magic, and contributes to an enemy's [Magical Attack](/srd/heroes/numbers#term-spell), [Magical Defense](/srd/heroes/numbers#term-magical-defense), [Magical Accuracy](/srd/heroes/numbers#term-magical-accuracy), and [Mana](/srd/heroes/numbers#term-mana).
*  _Cunning_ is a measure of how clever and evasive an enemy is, and contributes to an enemy's [Evasion](/srd/heroes/numbers#term-evasion), [Magical Accuracy](/srd/heroes/numbers#term-magical-accuracy), and [Status Accuracy](/srd/heroes/numbers#term-status-accuracy), and [Initiative](/srd/heroes/numbers#term-initiative).
