...
*  _Aggression_ is a measure of how vicious an enemy is in close quarters, and contributes to an enemy's [Physical Attack](/srd/heroes/attributes-and-statistics#term-strike), [Initiative](/srd/heroes/attributes-and-statistics#term-initiative), and [Physical Accuracy](/srd/heroes/attributes-and-statistics#term-physical-accuracy).
...
*  _Magic_ is a measure of how adept an enemy is at dealing with magic, and contributes to an enemy's [Magical Attack](/srd/heroes/attributes-and-statistics#term-spell), [Magical Defense](/srd/heroes/attributes-and-statistics#term-magical-defense), [Magical Accuracy](/srd/heroes/attributes-and-statistics#term-magical-accuracy), and [Mana](/srd/heroes/attributes-and-statistics#term-mana).
