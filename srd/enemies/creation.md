...
*  An enemy's _tier_ indirectly determines their [combat](/srd/combat) [statistics](/srd/characters/attributes-and-statistics#term-statistic) by setting the number of [attribute](/srd/key-terms#term-attribute) points available to allocate to determine their statistics.
