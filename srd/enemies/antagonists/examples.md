...
Entire [adventures](/srd/extras/key-terms#term-adventure) or even [campaigns](/srd/extras/key-terms#term-campaign) in Last Odyssey will often revolve around a handful of Antagonists.  Here are a few examples that are ready-made for the GM to use in their game.

## The Spider Queen

**[Domain](/srd/enemies/antagonists/monsters#term-domain):** Ancient Ruin.

**Description:** An underground ruin once home to a lost civilization is now the Domain of the Spider Queen, a [Monster](/srd/enemies/antagonists/monsters) whose spawn are the apex predators of its tiny but complex ecosystem.  The Queen herself spins her web throughout the ruin, capturing larger animals and the occasional traveler unwise or unlucky enough to stumble into her Domain.
...
|:-|:-|:-|:-|
|Leg Stab|[Melee](/srd/combat/attacking-and-defending#term-melee)|1 [AP](/srd/combat/round#term-ap)|Makes a [basic](/srd/combat/round#term-basic-attack) [physical attack](/srd/combat/attacking-and-defending#term-physical-attack).|
|Magic Spear|[Ranged](/srd/combat/attacking-and-defending#term-ranged)|1 AP, 3 [MP](/srd/characters/attributes-and-statistics#term-mp)|Makes a magical attack that inflicts [colorless](/srd/combat/elemental-types#term-colorless) magical damage on a  hit.|
|Bind|Ranged|1 AP, 7 MP|Uses a [status-inflicting ability](/srd/combat/attacking-and-defending#term-status-inflicting-ability) that inflicts Petrify on a hit.|
...
|Antimagic Field|[Special](/srd/combat/attacking-and-defending#term-special-ability)|Variable|The Webmaster can use the [Sage's](/srd/characters/archetypes/sage) Counterspell ability.|
|Eggs|[Passive](/srd/combat/attacking-and-defending#term-passive)|N/A|The Webmaster begins the [battle](/srd/extras/key-terms#term-battle) with 3 Eggs that can be used to create Spiderlings.|
...
|Harden|[Self](/srd/combat/attacking-and-defending#term-self-ability)|1 AP, 5 MP|The Tarantula [buffs](/srd/combat/buffs-and-debuffs#term-buff) its Physical Defense by 1 step on the Bonus Tracker.|
...
**[Ambition](/srd/enemies/antagonists/villains#term-ambition):** To Kill Every Last Stellish Person Still Breathing.
...
**[Eidolon](/srd/characters/eidolons#term-eidolon):** Hill Giant (Striker, Earth, Tier 3, Body 7, Mind 1, Spirit 1).
...
|Cleave|[Multi](/srd/combat/attacking-and-defending#term-multi)|1 AP, 7 MP|Makes a physical attack against all of the War Leader's enemies in the [front row](/srd/combat/starting#term-front-row) that does colorless physical damage on a hit.|
...
|Dragonslayer|[Paradigm Action](/srd/enemies/antagonists#term-paradigm-action)|1 [Anima](/srd/free-play/anima#term-anima)|The War Leader makes a physical attack that deals 4x physical colorless damage on a hit against enemies with full HP.  If an enemy is not at full HP, the attack deals 2x damage instead.|
...
|Frost Blast|Ranged|1 AP, 7 MP|Makes a [magical attack](/srd/combat/attacking-and-defending#term-magical-attack) against a single target that deals magical ice damage that is multiplied by 2 in addition to other modifiers.|
|Chill|Ranged|1 AP, 7 MP|Uses a status-inflicting ability against a single target that inflicts the [Frostbitten](/srd/combat/statuses#term-frostbitten) status on a hit.|
...
|Deep Cuts|Passive|N/A|If the Torture Rack rolls a 1 when making a physical attack against one of its enemies, it will also inflict 1 random [injury](/srd/combat/death-and-injury#term-injury).|
...
|Assassinate|Paradigm Action|1 Anima|The Torture rack designates an enemy, and the [GM](/srd/extras/key-terms#term-gm) rolls the [outcome die](/srd/extras/key-terms#term-outcome-die).  The target then loses a percentage of their total [Health](/srd/characters/attributes-and-statistics#term-health) from their combined HP and Shell equal to the result of the roll multiplied by 10.|
