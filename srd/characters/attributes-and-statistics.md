...
The capabilities of a [character](/srd/key-terms#term-character) during [battle](/srd/key-terms#term-battle) are represented by their [statistics](/srd/key-terms#term-statistic) and their [abilities](/srd/key-terms#term-ability).  [Player characters](/srd/key-terms#term-player-character) also have a set of three numbers called [attributes](/srd/key-terms#term-attribute) that determine what they can do in and out of combat. The abilities a player character can use are determined by the [job](/srd/characters/jobs) they occupy and its current rank, their [archetype](/srd/characters/archetypes), their [items](/srd/economy/items), their [equipment](/srd/economy/equipment), and whatever [flex powers](/srd/characters/advancement#term-flex-power) they have taken during [character advancement](/srd/characters/advancement).
...
*  A character's _<dfn id="term-health">Health</dfn>_ is their [base](/srd/key-terms#term-base) maximum HP during combat.  It is equal to their Body times 5 plus the bonus they receive from their archetype at [tier](/srd/characters/creation#term-tier) 1.
