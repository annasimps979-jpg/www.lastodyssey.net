...
The Thief's core virtue is their **Cunning.**  At [character creation](/srd/characters/creation), they gain the following traits:
*  [Proficiency](/srd/characters/creation#term-armor-proficiency) in [Light](/srd/economy/equipment/armor#term-light-armor) [armor](/srd/economy/equipment/armor).
*  [Proficiency](/srd/characters/creation#term-weapon-proficiency) in [Daggers](/srd/economy/equipment/weapons#term-dagger).
...
|Name|Type|Cost|Description|
|:-|:-|:-|:-|
|Sneak Attack|[Passive](/srd/combat/attacking-and-defending#term-passive)|If you use a physical attack, magical attack, or status-inflicting ability while Hidden, you may roll the [hit die](/srd/combat/attacking-and-defending#term-hit-die) twice and choose the result you prefer.|
...
**[Striker](/srd/characters/jobs/striker):** Lifesteal.  When you use Steal on an enemy and roll a 4 on their item table, you drain an amount of HP from them equal to your current Physical Attack and give it to yourself.

**[Caster](/srd/characters/jobs/caster):** Manasteal.  When you use Steal on an enemy and roll a 4 on their item table, you drain an amount of [MP](/srd/characters/attributes-and-statistics#term-mp) from them equal to your current [Magical Attack](/srd/characters/attributes-and-statistics#term-magical-attack) and give it to yourself.

**[Healer](/srd/characters/jobs/healer):** Night Shift.  You may use your Healer abilities while Hidden without removing the status from yourself.

**[Defender](/srd/characters/jobs/defender):** Ninja Bodyguard.  You may use Guard, Shield, Counter, and Reflect without losing the Hidden status.  If any of the effects of these abilities are triggered while you are Hidden, you lose the Hidden status.
